    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
            ...
            .sessionManagement(
                ...
                .permitAll()
                .requestMatchers(HttpMethod.POST, "/api/v1/tourist-spots")
                .hasAnyRole("ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/v1/tourist-spots/*")
                .hasAnyRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/tourist-spots/*")
                .hasAnyRole("ADMIN")
